...
export default function ProductUpdate() {
  ...
  const bannerSubmitHandler = (e) => {
    ...
    dispatch(updateProduct(updateProductId, bannerData));
  };

  useRunOnce({
    fn: () => {
      dispatch(productDetail(updateProductId));
    },
  });
  ...
  useEffect(() => {
    ...
    if (!pdLoading) {
      ...
      if (product.productDetails !== undefined) {
        setKey1(product.productDetails[0].heading);
        setKey2(product.productDetails[1].heading);
        setKey3(product.productDetails[2].heading);
        setKey4(product.productDetails[3].heading);
        setKey5(product.productDetails[4].heading);
        setValue1(product.productDetails[0].detail);
        setValue2(product.productDetails[1].detail);
        setValue3(product.productDetails[2].detail);
        setValue4(product.productDetails[3].detail);
        setValue5(product.productDetails[4].detail);
      }
      ...
      if (product.images !== undefined) {
        ...
        for (let i = 0; i < product.images.length; i++) {
          bimgArr.push(product.images[i].url);
        }
  ...
  }, [dispatch, navigate, error, isUpdated, pdError, pdLoading, product]);
